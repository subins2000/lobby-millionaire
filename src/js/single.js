$.extend(lobby.app, {
  ...
  init : function(){
    ...
    Fr.resources.progress = function(progress, no, total){
      ...
      $("#workspace .loading .progress .inner").css("width", progress + "%");
      $("#workspace .loading .status").html("Loading "+ no + "/" + total + "<br clear/>" + progress + "%");
    };
    ...
    Fr.resources.load(function(){
      ...
      $("#workspace .loading").fadeOut(1000, function(){
